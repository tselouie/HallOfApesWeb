  ...
  const functionCall = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const HOAContract = new ethers.Contract(contractAddress, contractABI, signer);
  ...
  */
  ...
  return (
    ...
    <div className="mainContainer">
      ...
      <span className="center"><img className="circle" src="/android-chrome-192x192.png" /></span>
        <div className="header">
         Hall Of Apes
        </div>
    { !currentAccount ? <a className="connBtn" onClick={connectWallet}>
          Connect Wallet
        </a> :     <div className="mint-nft">
